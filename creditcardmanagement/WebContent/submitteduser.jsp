...
<br>
<br>
 <center>Application of Submitted Users</center>
 <br>
<center>
...
if(ms.getStatus().equals("Submitted")){
...
<td><a href="editstatusform.jsp?id=<%=ms.getUid()%>">Update</a></td> </tr>
<%}}%> 
